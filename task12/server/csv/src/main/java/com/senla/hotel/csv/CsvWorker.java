...
public class CsvWorker {
    ...
    public List importData(Class<? extends AEntity> entityClass) throws IOException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ParseException {
        ...
        for (int i = 1; i < csvData.size(); i++) {
            ...
            AEntity importEntity = (AEntity) entityClass.newInstance();
            Field[] entityFields = entityClass.getDeclaredFields();
