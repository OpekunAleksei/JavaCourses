...
import com.senla.hotel.ui.action.Exit;
import com.senla.hotel.ui.menu.MenuItem;
import com.senla.hotel.ui.menu.Menu;
import com.senla.hotel.ui.action.rooms.GetSortEmptyRoomByPrice;
import com.senla.hotel.ui.action.rooms.GetSortEmptyRoomByCapacity;
import com.senla.hotel.ui.action.rooms.GetSortEmptyRoomByNumberOfStars;
import com.senla.hotel.ui.action.guest.AddService;
import com.senla.hotel.ui.action.rooms.ChangeRoomPrice;
import com.senla.hotel.ui.action.rooms.ChangeRoomStatus;
import com.senla.hotel.ui.action.service.ChangeServicePrice;
import com.senla.hotel.ui.action.guest.CreateGuest;
import com.senla.hotel.ui.action.rooms.CreateRoom;
import com.senla.hotel.ui.action.service.CreateService;
import com.senla.hotel.ui.action.guest.EvictedFromRoom;
import com.senla.hotel.ui.action.rooms.GetDetailsOfRoom;
import com.senla.hotel.ui.action.guest.GetGuestPriceForAccommodation;
import com.senla.hotel.ui.action.rooms.GetLeftThreeGuestOfRoom;
import com.senla.hotel.ui.action.rooms.GetListOfRoomsAvailableByDate;
import com.senla.hotel.ui.action.rooms.GetNumberEmptyRoom;
import com.senla.hotel.ui.action.guest.GetNumberGuestInHotel;
import com.senla.hotel.ui.action.guest.GetSortGuestByDateOfDeparture;
import com.senla.hotel.ui.action.guest.GetSortGuestByName;
import com.senla.hotel.ui.action.rooms.GetSortRoomByCapacity;
import com.senla.hotel.ui.action.rooms.GetSortRoomByNumberOfStars;
import com.senla.hotel.ui.action.rooms.GetSortRoomByPrice;
import com.senla.hotel.ui.action.guest.GetSortServicesOfGuestByPrice;
import com.senla.hotel.ui.action.guest.GetSortServisecOfGuestByCategory;
import com.senla.hotel.ui.action.exports.ExportGuests;
import com.senla.hotel.ui.action.exports.ExportRooms;
import com.senla.hotel.ui.action.exports.ExportServices;
import com.senla.hotel.ui.action.guest.SettleInRoom;

import com.senla.hotel.ui.action.imports.ImportGuests;
import com.senla.hotel.ui.action.imports.ImportRooms;
import com.senla.hotel.ui.action.imports.ImportServices;
import com.senla.hotel.ui.action.rooms.ChangeCapacity;
import com.senla.hotel.ui.action.rooms.ChangeNumberOfStars;
import com.senla.hotel.ui.action.rooms.CopyRoom;
import com.senla.hotel.ui.action.service.GetListOfServices;
...
public final class Builder {
    ...
    public void buildMainMenu() {
        ...
        serviceMenuItems.add(new MenuItem(" Get list of sevices", new GetListOfServices(), serviceMenu));
