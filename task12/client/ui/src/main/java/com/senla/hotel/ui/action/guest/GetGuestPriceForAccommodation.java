...
public class GetGuestPriceForAccommodation implements IAction {
    ...
    public void execute() {
        ...
        TextWorker.getInstance().println(Request.getInstance().pull(TextWorker.getInstance().createLine("getGuestPriceForAccommodation", TextWorker.getInstance().createData(id.toString(), number.toString()))));
