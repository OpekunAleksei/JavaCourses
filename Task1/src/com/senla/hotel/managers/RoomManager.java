...
public class RoomManager {
    ...
    public String getSortEmptyRoomsByCapacity() {
        Collections.sort(roomStorage.getArrayRoom(), new RoomComparator().getBusyComparator().thenComparing(new RoomComparator().getCapacityComparator()));
        return roomStorage.getLisOfEmptyRooms();

    }

    public String getSortRoomsByCapacity() {
        Collections.sort(roomStorage.getArrayRoom(), new RoomComparator().getCapacityComparator());
        return roomStorage.getLisOfRooms();
    }

    public String getSortEmptyRoomsByPrice() {
        Collections.sort(roomStorage.getArrayRoom(), new RoomComparator().getBusyComparator().thenComparing(new RoomComparator().getPriceComparator()));
        return roomStorage.getLisOfEmptyRooms();

    }

    public String getSortEmptyRoomsByNumberOfStars() {
        Collections.sort(roomStorage.getArrayRoom(), new RoomComparator().getBusyComparator().thenComparing(new RoomComparator().getNumberStarsComparator()));
        return roomStorage.getLisOfEmptyRooms();
    }

    public String getSortRoomsByPrice() {
        Collections.sort(roomStorage.getArrayRoom(), new RoomComparator().getPriceComparator());
        return roomStorage.getLisOfRooms();
    }

    public String getSortRoomsByNumberOfStars() {
        Collections.sort(roomStorage.getArrayRoom(), new RoomComparator().getNumberStarsComparator());
        return roomStorage.getLisOfRooms();
    }
