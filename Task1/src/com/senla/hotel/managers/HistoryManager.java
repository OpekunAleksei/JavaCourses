...
public class HistoryManager {
    ...
    public String getGuestSortServiceByPrice(Guest guest) {
        Collections.sort(historyStorage.getArrayGuestService(guest), new ServiceComparator().getServiceByPriceComparator());
        return historyStorage.getListOfGuestService(guest);
    }

    public String getSortListServiceGuestByCategory(Guest guest) {
        Collections.sort(historyStorage.getArrayGuestService(guest), new ServiceComparator().getServiceByCategoryComparator());
        return historyStorage.getListOfGuestService(guest);
    }
}
