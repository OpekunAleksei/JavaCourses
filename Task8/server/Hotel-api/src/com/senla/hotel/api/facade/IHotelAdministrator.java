...
public interface IHotelAdministrator {
    ...
    public void createRoom(String number, String price, String capacity, String numberOfStars, String id, String status);

    public void copyRoom(String numberOfRoom, String newId, String newNumber);

    public void createGuest(String name, String arrivalDate, String dateOfDeparture, String id);
    ...
    public void createService(String price, String category, String id);
