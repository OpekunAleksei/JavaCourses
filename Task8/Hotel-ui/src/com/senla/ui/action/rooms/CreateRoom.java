...
public class CreateRoom implements IAction {
    ...
    public void execute() {
        ...
        Request.getInstance().pull(textWorker.createLine("CreateRoom", textWorker.createData(number.toString(), price.toString(), capacity.toString(), numberOfStars.toString(), id.toString(), status.toString())));
