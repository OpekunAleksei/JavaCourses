...
public class GetSortServicesOfGuestByPrice implements IAction {
   ...
   getSortGuestByName.execute();
        ...
        textWorker.println(dataParser.parseData(Request.getInstance().pull(textWorker.createLine("GetSortServicesOfGuestByPrice", textWorker.createData(id.toString(), number.toString())))));
