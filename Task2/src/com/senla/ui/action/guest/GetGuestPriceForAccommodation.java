...
public class GetGuestPriceForAccommodation implements IAction {
    ...
    public void execute() {
        ...
        textWorker.println(HotelAdministrator.getInstance().getGuestPriceForAccommodation(HotelAdministrator.getInstance().getGuestIdByNumberOnList(textWorker.getIntegerInput() - 1)));
