...
public class GetSortServisecOfGuestByCategory implements IAction {
    ...
    public void execute() {
        ...
        printer.println( HotelAdministrator.getInstance(null, null, null).getSortListServiceGuestByCategory( HotelAdministrator.getInstance(null, null, null).getGuestIdByNumberOnList(helper.getIntegerInput()-1)));
