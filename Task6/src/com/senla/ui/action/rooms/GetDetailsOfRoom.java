...
public class GetDetailsOfRoom implements IAction {
    ...
    public void execute() {
        ...
        textWorker.println(HotelAdministrator.getInstance().getDetailsOfRoom(HotelAdministrator.getInstance().getRoomNumberByNumberOnList(textWorker.getIntegerInput() - 1)));
