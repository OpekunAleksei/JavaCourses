...
public class SettleInRoom implements IAction {
    ...
    public void execute() {
        ...
        Integer numberRoom = HotelAdministrator.getInstance().getRoomNumberByNumberOnList(textWorker.getIntegerInput() - 1);

        HotelAdministrator.getInstance().settleInRoom(guestId, numberRoom);
